...
const AdminDashboard = () => {
  ...
  const [activeTab, setActiveTab] = useState<"users" | "payments" | "budget">(
    "users",
  );
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const totalCredits = usersData.reduce(
    ...
    try {
      ...
      if (error) {
        ...
        toast({
          ...
          description:
            "Admin operations Edge Function is not responding. Please check deployment.",
          variant: "destructive",
        });
        return false;
      }
      ...
      toast({
        ...
        description:
          "Cannot connect to admin operations. Please check your connection.",
        variant: "destructive",
      });
      return false;
    }
  ...
  const handleGiveCredits = async (userId: string, amount: number) => {
    console.log(
      "🔄 Admin: Updating credits for userId:",
      userId,
      "amount:",
      amount,
    );
  ...
  const handleResetAllCredits = async () => {
    if (
      !confirm(
        "Are you sure you want to reset ALL user credits to 0? This cannot be undone.",
      )
    ) {
      return;
    }
    ...
    <AdminRoute>
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50">
                  ...
                  {budgetStats ? (
                        ...
                        <Card>
                          <CardContent className="pt-6">
                            <div className="flex items-center space-x-2">
                              ...
                              <div>
                                <p className="text-2xl font-bold text-blue-600">
                                  {budgetStats.current_period?.used_credits ||
                                    0}
                                </p>
                        ...
                        <CardContent>
                          <div className="space-y-4">
                            <div className="flex justify-between items-center">
                              ...
                              <span>
                                {budgetStats.current_period?.name || "N/A"}
                              </span>
                            </div>
                            <div className="flex justify-between items-center">
                              <span className="font-medium">Total Limit:</span>
                              <Badge variant="outline" className="font-mono">
                                {budgetStats.current_period?.total_limit || 0}{" "}
                                credits
                              </Badge>
                            </div>
                            <div className="flex justify-between items-center">
                            ...
                            <div className="flex justify-between items-center">
                              ...
                              <Badge
                                variant={
                                  budgetStats.current_period?.hard_limit_enabled
                                    ? "destructive"
                                    : "secondary"
                                }
                              >
                          ...
                          <div className="mt-4">
                            <div className="flex justify-between text-sm text-gray-600 mb-1">
                              ...
                              <span>
                                {budgetStats.current_period?.usage_percentage ||
                                  0}
                                %
                              </span>
                            </div>
                          ...
                          <div className="mt-4 flex space-x-2">
                            <Button
                              ...
                              onClick={() =>
                                setBudgetDialog({
                                  open: true,
                                  type: "update",
                                  data: budgetStats.current_period,
                                })
                              }
                            >
                            ...
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                setBudgetDialog({ open: true, type: "create" })
                              }
                            >
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-600 mb-2">
                        Budget statistics unavailable
                      </p>
                      <p className="text-sm text-gray-500 mb-4">
                        This feature requires the budget system database schema.
                        Please apply the SQL schema from
                        supabase/credit-budget-system.sql
                      </p>
                      <Button
                        variant="outline"
                        onClick={fetchBudgetStats}
            ...
            <DialogFooter>
              ...
              <Button
                onClick={() =>
                  ...
                  handleResetPassword(resetPasswordDialog.user.email)
                }
              >
                Send Reset Email
              </Button>
        ...
        <Dialog
          ...
          onOpenChange={(open) =>
            setCreditDialog({ open, user: null, amount: "" })
          }
        >
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Current credits for {creditDialog.user?.email}:{" "}
                {creditDialog.user?.credits}
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              <div>
              ...
              <div className="flex space-x-2">
                <Button
                  variant="outline"
                  onClick={() =>
                    setCreditDialog((prev) => ({ ...prev, amount: "1" }))
                  }
                  size="sm"
                >
                  <Plus className="h-4 w-4 mr-1" />
                ...
                <Button
                  variant="outline"
                  onClick={() =>
                    setCreditDialog((prev) => ({ ...prev, amount: "10" }))
                  }
                  size="sm"
                >
                  <Plus className="h-4 w-4 mr-1" />
                ...
                <Button
                  variant="outline"
                  onClick={() =>
                    setCreditDialog((prev) => ({ ...prev, amount: "25" }))
                  }
                  size="sm"
                >
                  <Plus className="h-4 w-4 mr-1" />
            ...
            <DialogFooter>
              ...
              <Button
                ...
                disabled={
                  !creditDialog.amount || isNaN(parseInt(creditDialog.amount))
                }
              >
                Update Credits
              </Button>
